...
"[project]/src/app/api/catalog-items/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const items = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].catalogItem.findMany({
            orderBy: {
                name: "asc"
            }
        });
...
async function POST(request) {
    try {
        ...
        const item = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].catalogItem.create({
            data: {
                name: body.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__50764257._.js.map